...
public sealed class StudentVerificationApplication
{
    ...
    public void Approve(Guid adminId) { Status = StudentVerificationStatus.Approved; AdminId = adminId; ReviewedAt = DateTime.UtcNow; }
    public void Reject(Guid adminId, string? note) { Status = StudentVerificationStatus.Rejected; AdminId = adminId; AdminNote = note; ReviewedAt = DateTime.UtcNow; }
}
